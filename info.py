...
PICS = (environ.get('PICS', 'https://files.catbox.moe/19t7xi.jpg '
        ...
        'https://files.catbox.moe/1fhksy.jpg')).split()# Sample pic

NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/img407.jpg')).split()  # Fsub pic
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5770911041').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003360890810').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003554232238'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003576410674'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003500997424'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003639224538')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003648977887')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+B1VMLwRnMk0xZDA1')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002716491516 -1002463907537 -1002942665973 -1003570778964")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://ibb.co/678wSTfC')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'kumarnikhil05848-1@oksbi')    # Owner UPI ID for payments
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003498867423')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003209904648')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/+ndqncL_lSTlmYjA1")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+ndqncL_lSTlmYjA1")   # Second tutorial link for verification
...
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "None") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "None")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "None") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+atChu7RZqdVjMjI1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Sensei_support_vbot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+_mPubrIyTE03NjRl') # Update channel link for the bot
